 ...
 local tbl_19_auto = {} local i_20_auto = 0 for _, f in ipairs(files) do local val_21_auto
 ...
 val_21_auto = mod0 elseif ((_2_ == false) and (nil ~= _3_)) then local err = _3_
 val_21_auto = nil else val_21_auto = nil end end if (nil ~= val_21_auto) then i_20_auto = (i_20_auto + 1) do end (tbl_19_auto)[i_20_auto] = val_21_auto else end end return tbl_19_auto end
